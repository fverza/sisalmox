              ...
              <div className="p-8 rounded-2xl glassmorphism space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-4 bg-brand-500/10 border border-brand-500/20 rounded-xl flex items-start justify-between">
                    <div className="space-y-1">
                      <div className="flex items-center space-x-2">
                        <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-brand-500/20 text-brand-400">FASE 2</span>
                        <h3 className="font-semibold text-white text-sm">Estrutura de Cadastro e Migração</h3>
                      </div>
